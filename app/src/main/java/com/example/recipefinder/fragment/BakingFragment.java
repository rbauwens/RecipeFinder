...
public class BakingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_baking, parent, false);
    }

    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {

        RecyclerView settingsRecyclerView = view.findViewById(R.id.baking_recipe_list);
        ...
        List<RecipeViewItem> filteredRecipeList = Common.getRecipesByTag(totalRecipeList, "Baking");
