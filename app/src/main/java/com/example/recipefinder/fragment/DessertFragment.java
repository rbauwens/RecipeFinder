...
public class DessertFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_dessert, parent, false);
    }

    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {

        RecyclerView settingsRecyclerView = view.findViewById(R.id.dessert_recipe_list);
        ...
        List<RecipeViewItem> filteredRecipeList = Common.getRecipesByTag(totalRecipeList, "Dessert");
